//This variable keepss track of whose turn it is.
let activePlayer = 'X';
...
function placeXOrO(squareNumber) {
    ...
    //This function results in a random square being sleceted by the computer.
...
//drawLine() function is called to draw a line on the screen if the codition is met.
function checkWinConditions() {
    ...
    // X 2, 5, 8 condition.
    else if (arrayIncludes('2X', '5X', '7X')) (drawWinLine(508, 50, 508, 558) )
    // X 6, 4, 2 condition.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true if returned and our else if condition executes the drawLine() funtion.
...
function audio(audioURL) {
    ...
    //Play method plays or audio sound.
    audio.play();
}
...
function drawWinLine(coordX1, coordY1, CoordX2, CoordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method draws everything we laid ou above.
        c.stroke();
...
//This function resets the game in the event of a ties or a win.
function resetGame() {
